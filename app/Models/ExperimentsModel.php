...
class ExperimentsModel extends Model
{
    ...
    public function getExperimentsAll()
    {
        return $this->db->table($this->table)
            ->join('users', 'experiments.experiments_user=users.users_id')
            ->join('scales', 'experiments.experiments_scales=scales.scales_id')
            ->get()->getResultArray();
    }
    ...
    public function getExperimentByID($experiments_id)
    {
        return $this
            ...
            ->join('users', 'experiments.experiments_user=users.users_id')->first();
    }
